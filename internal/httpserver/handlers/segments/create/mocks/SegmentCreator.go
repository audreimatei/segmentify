...
func (_m *SegmentCreator) CreateSegment(slug string) (models.Segment, error) {
	ret := _m.Called(slug)

	var r0 models.Segment
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (models.Segment, error)); ok {
		return rf(slug)
	}
	if rf, ok := ret.Get(0).(func(string) models.Segment); ok {
		r0 = rf(slug)
	} else {
